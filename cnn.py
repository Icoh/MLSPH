...
n_files, N = list(hf.get('shape'))
im_size = features.shape[1]
...
print("Nb. of files:{}. Nb. of particles:{}".format(n_files, N))

X = features.reshape(n_files, im_size, im_size, 1)
...
model.add(layers.Conv2D(16, (4, 4), activation='relu',  input_shape=(im_size, im_size, 1)))
